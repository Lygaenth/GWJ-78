...
func _ready():
	...
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Patient, "You see, I have been a Gaiist for all my life."))
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Patient, "Trying to restore our wounded Earth with my little cult friends..."))
