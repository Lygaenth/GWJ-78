...
func _ready():
	...
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "Not knowing exactly where you are? Having trouble learning new information?"))
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Patient, "How do you know?"))
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "Partly because of the neurojack on your occipital bone..."))
	...
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "(He was probably robbed by someone at this bar. They hijacked his memory to cover their tracks...)"))
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "(...but they ended up damaging it)"))
	_startLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "Alright. Now, I want you to connect to your neurojack."))
	...
	_drunkEndingLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "I bet Vahn likes a good bottle of Varanid wine, don't they?"))
	_drunkEndingLines.append(DialogLineFactory.CreateLine(Enums.Talker.Patient, "Anyways, you should go home. It will probably pass after a good rest."))
	...
	# Thief ending
	_thiefEndingLines.append(DialogLineFactory.CreateLine(Enums.Talker.Patient, "I was robbed? Oh, stars! How come I don't remember?"))
	_thiefEndingLines.append(DialogLineFactory.CreateLine(Enums.Talker.Doctor, "They probably used your neurojack as an entry point your memory."))
